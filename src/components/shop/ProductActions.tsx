        ...
        <div className="mt-4 notranslate" translate="no">
          ...
          <div className="space-y-4 notranslate" translate="no">
            {Object.values(attributeGroups).map((group) => (
              <div key={group.attributeName} className="space-y-2 notranslate" translate="no">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-semibold text-foreground notranslate" translate="no">
                    <span className="notranslate" translate="no">{group.attributeName}</span>
                  </label>
                ...
                <Popover open={openGroup === group.attributeName} onOpenChange={(isOpen) => setOpenGroup(isOpen ? group.attributeName : null)}>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        "w-full h-12 text-base justify-between border-2 transition-colors font-normal notranslate",
                  ...
                  <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0 notranslate" align="start" translate="no">
                    <Command className="notranslate" translate="no">
                      <CommandList className="notranslate" translate="no">
                        <CommandEmpty className="notranslate" translate="no">No options found.</CommandEmpty>
                        <CommandGroup className="notranslate" translate="no">
                          {group.options.map((optValue) => (
                            <CommandItem
                              ...
                              className={cn(
                                "text-base py-2.5 cursor-pointer flex items-center notranslate",
                            ...
                            >
                              ...
                              />
                              <span className="notranslate" translate="no">{optValue}</span>
                            </CommandItem>
                          ))}
                        </CommandGroup>
                      </CommandList>
